...
const Home = () => {
  ...
  return (
    ...
    <div name="home" className=' pt-52 md:pt-32 min-h-screen w-full bg-gradient-to-b from-black via-black to-gray-800 px-4'>
        
        <div className='max-w-screen-lg mx-auto flex flex-col-reverse  items-center justify-center h-full px-4 text-white lg:flex-row'>

            <div className='flex flex-col justify-center items-center lg:items-start h-full lg:pl-12'>

                <h2 className=' text-xl  text-center lg:text-left md:text-2xl lg:text-4xl font-bold text-white' >I'm a Frontend Developer</h2>
